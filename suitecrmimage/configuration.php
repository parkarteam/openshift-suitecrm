...
class config
{
  ...
  function __construct(){
    ...
    /* Database */
    $this->dbHost = $this->configEnvironmentHelper("DATABASE_HOST", $this->dbHost);
    $this->dbUser = $this->configEnvironmentHelper("DATABASE_USER", $this->dbUser);
    $this->dbPassword = $this->configEnvironmentHelper("DATABASE_PASSWORD", $this->dbPassword);
    $this->dbDatabase = $this->configEnvironmentHelper("DATABASE_NAME", $this->dbDatabase);
    ...
    /* Sessions */
    $this->sessionpassword = $this->configEnvironmentHelper("LEANTIME_SECRET_TOKEN", $this->sessionpassword);
